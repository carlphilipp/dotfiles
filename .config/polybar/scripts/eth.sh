...
if [ "$IS_CONNECTED" == "1" ]
then
    RESPONSE=$(curl -s https://min-api.cryptocompare.com/data/pricemultifull\?fsyms\=ETH\&tsyms\=USD\&api_key=b13f76b096bc9b7e7eac7d83f7e28fec56463194b875fa3d377e26d4db94c078)
